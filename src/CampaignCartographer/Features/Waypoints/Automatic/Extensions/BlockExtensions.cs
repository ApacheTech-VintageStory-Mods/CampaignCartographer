...
namespace ApacheTech.VintageMods.CampaignCartographer.Features.Waypoints.Automatic.Extensions;
...
public static class BlockExtensions
{
    ...
    {
        return block.Code.Path.ContainsAnyOf(["-looseores-", "-loosestones-"]);
    }
    /// <summary>
