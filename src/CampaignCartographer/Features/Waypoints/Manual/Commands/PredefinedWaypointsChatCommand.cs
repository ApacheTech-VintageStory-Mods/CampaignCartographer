...
namespace ApacheTech.VintageMods.CampaignCartographer.Features.Waypoints.Manual.Commands;
...
public sealed class PredefinedWaypointsChatCommand : ClientChatCommand
{
    ...
    public override string GetHelpMessage()
    {
        return new StringBuilder()
            .AppendLine(LangEx.FeatureString("PredefinedWaypoints.PredefinedWaypoints", "Title"))
            .AppendLine()
            .AppendLine(GetDescription())
            .AppendLine()
            .AppendLine(GetSyntax())
            .ToString();
    }
