...
/// </summary>
[JsonObject]
public class AutoWaypointsSettings : FeatureSettings<AutoWaypointsSettings>
{
    /// <summary>
    ///     Determines whether to add a waypoint whenever the player dies.
    /// </summary>
    public bool DeathWaypoints { get; set; }
